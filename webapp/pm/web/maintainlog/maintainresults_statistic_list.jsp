...
<script type="text/javascript" src="<%=request.getContextPath()%>/pm/web/maintainlog/js/maintainresult_statistic_list.js"></script>
</head>
<!-- list -->
...
<tr>
        ...
        <td class="w80">{{:amt}}</td> 
        <td class="w47"><a href="javascript:gotoMachinePage('{{:maintenance_id}}')"  class="btn3">详情</a></td> 
</tr> 
</tbody>
</script>
<body>
   <%@ include file="/pm/common/jsp/top_left_menu.jsp"%>
    <div class="contents">
          <div class="main_wrap" >
          		<!--breadcrumbs-->
            	<div class="crumbs" id="bre_left"><img src="<%=request.getContextPath()%>/pm/common/images/ico/position.png" class="mr10" /><a href="">报表信息</a>&nbsp;>&nbsp;维修故障统计</div>
            
            	<!--右侧 开始--> 
            	<div class="main" id="aaa">                
                		<div class="title mb18">维修故障统计</div>
  						<!--查询条件-->

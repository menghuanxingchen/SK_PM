				...
				success:function(data){
					...
					for(var i=0;i<data.data.length;i++){
						...
						strbody =strbody+"<tr><td>"+(i+1)+"</td><td>"+data.data[i].pkg+"</td><td>"+data.data[i].pkgname+"</td>" +
								...
								"<td><a href='/PM/pm/web/sqmquery/sample_detail_manager.jsp?colcnt=5&pkg="+data.data[i].pkg+"&prod="+data.data[i].prodcode+"&revno="+data.data[i].samplevcode+"'>"+data.data[i].samplev+"</a></td>" +
								...
								"<td><a href='/PM/pm/web/sqmquery/sample_detail_manager.jsp?colcnt=10&pkg="+data.data[i].pkg+"&prod="+data.data[i].prodcode+"&revno="+data.data[i].sampletcode+"'>"+data.data[i].samplet+"</a></td>" +
								...
								"<td><a href='/PM/pm/web/sqmquery/sample_detail_manager.jsp?colcnt=15&pkg="+data.data[i].pkg+"&prod="+data.data[i].prodcode+"&revno="+data.data[i].samplebcode+"'>"+data.data[i].sampleb+"</a></td>" +
								...
								"<td><a href='/PM/pm/web/sqmquery/sample_detail_manager.jsp?colcnt=20&pkg="+data.data[i].pkg+"&prod="+data.data[i].prodcode+"&revno="+data.data[i].sampleccode+"'>"+data.data[i].samplec+"</a></td>" +

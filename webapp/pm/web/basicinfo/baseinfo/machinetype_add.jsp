...
<script type="text/javascript" src="<%=request.getContextPath()%>/pm/web/basicinfo/baseinfo/js/machinetype_add.js"></script>
<!-- 设备类别 -->
<script type="text/x-jsrender" id="machinespeciesListTemplate">
	<select name="sysCodeInfo.code_group_value" dc="true" dcrequired="请选择设备类别 ">
            	...
            	<div class="main" id="aaa">
            			...
            			<table id="addform" class="tt record_table table_wrap mt18" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td colspan="3" id="machinespecies">
                                </td>
                            </tr>

                            <tr>
                            	<td class="odd">设备类型名称</td>
                                <td colspan="3"><input name="sysCodeInfo.code_nm" type="text" value=""  dc="true" dcrequired="请输入设备类型名称" maxlength="50"/></td>
                            </tr>                            
                        </table>

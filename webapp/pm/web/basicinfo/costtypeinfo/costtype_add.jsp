    ...
    <div class="contents">
          <div class="main_wrap" id="formId">
            	...
            	<div class="main" id="aaa">
                		...
                		<div class="title mb18">费用类别信息新增</div>
  						
                        <table class="tt  tt2 record_table table_wrap mt18" border="0" cellspacing="0" cellpadding="0">
                        	<tr>
                            	<td class="odd w10">费用类别名称</td>
                                <td><input type="text" placeholder="请输入名称" dcrequired="请输入名称" name="sysCodeInfo.code_nm"   dc="" maxlength="50"/></td>
                            </tr>
                        </table>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/basicinfo/costtypeinfo/js/costtype_add.js"></script>
</html>
...
<tr> 
        ...
        <td>{{:pot_nm}}</td> 
        <td class="w110">{{:production_date}}</td> 
        <td class="w110">{{:use_year}}</td> 
        <td class="w110">{{:supplier}}</td> 
        <td class="w47"><a href="javascript:returnInfo('{{:pot_id}}','{{:pot_nm}}')"  class="btn3">选择</a></td> 
</tr> 
</tbody>
</script>
<body>
    ...
    <div class="contents" style="padding-top:  0px;">
          <div class="main_wrap" >
            	<!--右侧 开始--> 
            	<div class="main" id="aaa" style="margin-left: 10px;margin-right:  10px;">                
  						<!--查询条件-->
...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/basicinfo/machinemanager/js/machine_pot_add_POP.js"></script>
</html>

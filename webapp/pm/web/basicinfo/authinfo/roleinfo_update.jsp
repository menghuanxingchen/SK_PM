...
<script type="text/x-jsrender" id="dataListTemplate">
      <tr>
     	<td class="odd w10">角色名称</td><input type="hidden" value="{{:sysCodeInfo.code_id}}"  name="sysCodeInfo.code_id"   dc=""/>
         <td><input type="text" value="{{:sysCodeInfo.code_nm}}" name="sysCodeInfo.code_nm" maxlength="50" dc=""/></td>
     </tr>
</script>
<body>
    ...
    <div class="contents">
          <div class="main_wrap" id="formId">
            	...
            	<div class="main" id="aaa">
                		...
                		<div class="title mb18">角色信息修改</div>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/basicinfo/authinfo/js/roleinfo_update.js"></script>
</html>
    ...
    <div class="contents">
          <div class="main_wrap" >
            	...
            	<div class="main" id="aaa">
                		...
                		<div class="title mb18">角色信息<a href="javascript:addEntityDataFun();" class="btn1 f14 fb fr">新增</a></div><!--1019-->
  						<!--查询条件-->
                          <table class="w_auto" border="0" cellspacing="0" cellpadding="0" id="search_area">
                          	<tr>
                                <td>
                                    	角色名称 <input class="mr20" type="text"  name="sysCodeInfo.code_nm" dc=""/>
                                </td>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/basicinfo/authinfo/js/roleinfo_list.js"></script>
</html>
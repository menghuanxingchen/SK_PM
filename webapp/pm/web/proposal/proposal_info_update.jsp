...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/proposal/js/proposal_info_update.js"></script>
<script type="text/x-jsrender" id="proposalItemdownListTemplate">
	<select id="proposal_type" name="proposalInfo.proposal_type" dc="true" dcrequired="请选择内容分类">
...
<script type="text/x-jsrender" id="sysUserInfoDownListTemplate3">
	<select id="user_id5" name="approveInfoList[3].approve_user_id" dc="true" dcrequired="请选择验证人">
...
<script type="text/x-jsrender" id="loginUserInfoDownListTemplate">
	<select id="user_id1" name="approveInfoList[0].approve_user_id" dc="true" dcrequired="请选择申请人">
		{{renderOptionFun loginUser "user_num" "user_nm" loginUser[0].user_num ""/}}
 	</select>
</script>
<script type="text/x-jsrender" id="factoryManagerInfoDownListTemplate2">
	<select id="user_id4" name="approveInfoList[2].approve_user_id" dc="true" dcrequired="请选择分配人">
		{{renderOptionFun sysUserInfoList "user_num" "user_nm" appuser1.approve_user_id ""/}}
 	</select>
</script>
<script type="text/x-jsrender" id="factoryManagerInfoDownListTemplate4">
	<select id="user_id6" name="approveInfoList[4].approve_user_id" dc="true" dcrequired="请选择审批人">
    ...
    <div class="contents">
          <div class="main_wrap" >
            	...
            	<div class="main" id="aaa">
                		...
                		<div class="title mb18">Report修改</div>
  						<!--表格-->
                        ...
                        <div class="tex_c mt22">
	                        <a href="javascript:updateRepairOrderInfoData();" class="btn1 f14 fb mr10">提交</a>

...
<script type="text/javascript" src="<%=request.getContextPath()%>/pm/web/proposal/js/proposal_improvement_effect_pop.js"></script>
</head>
<body id="pop">
    <div class="pop_box">
          <div class="popup">
            	...
            	<div id="aaa">                
                          ...
                          <table class="tt  tt2 record_table table_wrap mt18" border="0" cellspacing="0" cellpadding="0" id="improvement_effect_table">
                             <tr>
                               ...
                               <td colspan="3"><textarea rows="3" id="improvement_effect" name="proposalOperateInfo.improvement_effect" dc="true" dcrequired="请输入改善效果"></textarea></td>
                            </tr>
                         </table>

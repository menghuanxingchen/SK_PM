...
<script type="text/x-jsrender" id="addformTemplate">
  <tr>
                                ...
                                <td colspan="3"><input name="emergentRepairInfo.repair_content" type="text" value="{{:repair_content}}"  dc="true" dcrequired="请输入工作内容" maxlength="50"/>
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input id="repair_date" name="emergentRepairInfo.repair_date" type="text" value="{{:repair_date}}"  dc="true" dcrequired="请选择维修日期" maxlength="50" readonly/></td>
                            	<td class="odd">维修人员</td>
                                <td colspan="3"><input name="emergentRepairInfo.repair_person" type="text" value="{{:repair_person}}"  dc="true" dcrequired="请输入维修人员，设备关键词" maxlength="50"/></td>
                            </tr>      
                            <tr>
                            	<td class="odd">设备</td>
                            	<td colspan="3"><input type="text" id="selPotNm" value="{{:pot_id_nm}}" class="mr20" readonly/>
                                ...
                                <td colspan="2" id="potPartList">
                                	<select id="pot_part" name="emergentRepairInfo.pot_part_id" dc="true" class="mr20" disabled="disabled">
										{{renderOptionFun data "pot_part_id" "pot_part_nm" pot_part_id "部件"/}}
 									</select>
                                </td>
                            	<td colspan="2" id="sonPotList">
									<select id="job_type" name="emergentRepairInfo.pot_son_part_id" dc="true" class="mr20" disabled="disabled">
                            ...
                            <tr>
                                ...
                                <td colspan="3"><input name="emergentRepairInfo.start_time" id="rep_st" disabled="disabled" type="text" value="{{:start_time}}"  dc="true" maxlength="50"/></td>
                                <td class="odd">结束时间</td>
                                <td colspan="3"><input name="emergentRepairInfo.end_time" id="rep_ed" disabled="disabled" type="text" value="{{:end_time}}"  dc="true" maxlength="50"/></td>
                            </tr>  
							<tr>
                            	<td class="odd w10">分钟数</td>
                                <td colspan="3"><input type="text" name="emergentRepairInfo.emergent_hours" disabled="disabled"  dc="true" id="emergent_hours"  value="{{:emergent_hours}}"/>
								</td> 	                           
							</tr>      
</script>
    ...
    <div class="contents">
          <div class="main_wrap" >
            	...
            	<div class="main" id="aaa">
                		...
                		<div class="title mb18">停机维修修改</div>  						
...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/emergentrepair/js/emergent_repair_info_upd.js"></script>
</html>

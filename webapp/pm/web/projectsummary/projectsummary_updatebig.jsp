...
<script type="text/x-jsrender" id="formTemplate">
	<tr>
        <td class="odd w10">项目名称</td>
			...
			<input type="hidden" name="projectSummaryInfo.big_project_group_id"  value="{{:big_project_group_id}}" dc="true" />
			<input type="hidden" name="projectSummaryInfo.project_type"  value="{{:project_type}}" dc="true" />
        <td id="repairPlace"><input type="text" name="projectSummaryInfo.project_nm" id="projectNm" value="{{:project_nm}}" onblur="javascript:changeBigProNm('{{:project_nm}}','{{:project_type}}');" dcrequired="请输入名称" dc="true" maxlength="25" />
        </td>
        <td class="odd w10">步骤</td>
        <td  id="projectStep">
			       <select name="projectSummaryInfo.big_project_step" class="mr20"  dc="true" >
						{{renderOptionFun projectStep "code_value" "code_nm" big_project_step "noflag" /}}
	 				</select>
        </td>
    </tr>
    <tr>
        <td class="odd w10">内容</td>
        <td><input type="text" name="projectSummaryInfo.content" value="{{:content}}" dc="true" maxlength="100" dcrequired="请输入内容"/></td>  	
        <td class="odd">负责人</td>
	...
	<tr>
        <td class="odd">交期</td>
        <td>
           	<input style="width:96%;margin-right:5px;" type="text" name="projectSummaryInfo.delivery_time"  value="{{:delivery_time}}" dc="true" />天
        </td>
        <td class="odd"></td>
        <td>
        </td>
...
<script type="text/x-jsrender" id="formListTemplate">
		<tr id="addr{{:#index}}">
			...
			<td><input type="text" name="projectSummaryDetailList[{{:#index}}].work_content" value="{{:work_content}}" dc="true" maxlength="100"/></td>

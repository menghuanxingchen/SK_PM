...
function bindevent(){	
	...
	$("#gobackBt").bind('click',function(){
		pageForward('/pm/web/systemfunction/material_unit_list.jsp');
	});
}
...
function updateFormData(){
	...
	if(checkflag){
		layer.confirm("是否提交", {
			...
			$.ajax({
				url:getRequestUrl("/SupplierController/updateSysCodeInfo.json"),
				dataType:"json",
				data:postData,
...
function getInfo(id){
	$.ajax({
		url : getRequestUrl("/SupplierController/querySysCodeInfo.json"),
		dataType:"json",

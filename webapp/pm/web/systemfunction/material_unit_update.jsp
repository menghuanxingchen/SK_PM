...
<script type="text/javascript" src="<%=request.getContextPath()%>/pm/web/systemfunction/js/material_unit_update.js"></script>
<script type="text/x-jsrender" id="formTemplate">
    <tr>
    	<td class="odd w10">材料单位名称</td>
        <td>
		<input name="sysCodeInfo.code_nm" value="{{:data.code_nm}}" type="text" dcrequired="请输入材料单位名称" dc="true" maxlength="50"/></td>
     </tr>
</script>
</head>
<body>
    ...
    <div class="contents">
          <div class="main_wrap" >
            	...
            	<div class="main" id="aaa">
                		...
                		<div class="title mb18">材料单位修改</div>  						

...
function queryDataList(){
	...
	var parameterData = {
			url:getRequestUrl("/TestItemInfoController/queryDataList.json"),
...
function addEntityDataFun(){
	var page = "/pm/web/sqmmanage/test_item_info_add.jsp";
	pageForward(page);
}
...
function updateEntityDataFun(id){
	var page = "/pm/web/sqmmanage/test_item_info_upd.jsp?id="+id;
	pageForward(page);
}
...
function deleteDataFun(id){
	$.ajax({
		url:getRequestUrl("/TestItemInfoController/deleteEntityData.json"),
		dataType:"json",
		data:{"testItemInfo.id":id},
...
function beginDataFun(id){
	$.ajax({
		url:getRequestUrl("/TestItemInfoController/beginEntityData.json"),
		dataType:"json",
		data:{"testItemInfo.id":id},
		success:function(result){
			lalert("handle","success");

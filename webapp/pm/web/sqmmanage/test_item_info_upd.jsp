...
<script type="text/x-jsrender" id="dataListTemplate">
         ...
         <td >
            ...
            <td class="odd">选型</td>
             <td >
             <input type="text" disabled="disabled" dctype="选型" name="testingProcessInfo.productType" value="{{:testingProcessInfo.productType}}"  />
            </td>        	
         </tr>
                            <tr>
                            	<td class="odd">产品Code</td>
                                <td><input type="text" disabled="disabled" dctype="产品Code" name="testingProcessInfo.productCode" value="{{:testingProcessInfo.productCode}}"  /></td>
                                <td class="odd">产品名称</td>
                                <td><input type="text" disabled="disabled" dctype="产品名称" name="testingProcessInfo.productName" value="{{:testingProcessInfo.productName}}"  /></td>
                            </tr>
                            <tr>
                                <td class="odd">客户</td>
                                <td><input type="text" disabled="disabled" dctype="客户" name="testingProcessInfo.customName" value="{{:testingProcessInfo.customName}}" dc="" /></td>
                                <td class="odd">设备</td>
                                <td><input type="text" disabled="disabled" dctype="设备" name="testingProcessInfo.equipmentName" value="{{:testingProcessInfo.equipmentName}}" /></td>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/sqmmanage/js/test_item_info_upd.js"></script>
</html>
...
<%@ include file="/pm/common/jsp/top_left_menu.jsp"%>
    <div class="contents">
          <div class="main_wrap" >
          		<!--breadcrumbs-->
            	<div class="crumbs" id="bre_left"><img src="<%=request.getContextPath()%>/pm/common/images/ico/position.png" class="mr10" /><a href="">SQM检测结果</a>&nbsp;>&nbsp;1-4L检测结果详情</div>
            	<!--右侧 开始--> 
            	<div class="main" id="aaa">
                
                		<div class="title mb18">1-4L检测结果详情<a href="javascript:history.go(-1)" class="btn1 f14 fb fr">返回</a>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/pm/web/sqmtestingmanage/js/testing4_resultdetail.js"></script>
</html>
...
function queryDataList(){
	...
	var parameterData = {
			url:getRequestUrl("/SqmtestingManageController/query18DataList.json"),
...
function detailEntityDataFun(lineId,lotnumver,produnctCode){
	var page = "/pm/web/sqmtestingmanage/testing18_resultdetail.jsp?lineId="+lineId+"&&lotnumver="+lotnumver+"&&produnctCode="+produnctCode;
	pageForward(page);
}

...
function queryDataList(){
	...
	var parameterData = {
			url:getRequestUrl("/SqmtestingManageController/query200DataList.json"),
...
function detailEntityDataFun(lineId,lotnumver,produnctCode){
	var page = "/pm/web/sqmtestingmanage/testing200_resultdetail.jsp?lineId="+lineId+"&&lotnumver="+lotnumver+"&&produnctCode="+produnctCode;
	pageForward(page);
}

			...
			return this
					.each(function() {
						...
						if (h) {
							...
							var f = c("<div />", {
								id : j.id + "-button",
								//"class" : "uploadify-button " + j.buttonClass//TODO
								"class" : " " + j.buttonClass
							});
							if (j.buttonImage) {
								f.css( {
	...
	var a = {
		...
		onSelect : function(h) {
			...
			if (i.itemTemplate == false) {
				...
				i.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">					<span class="fileName">${fileName} (${fileSize})</span><span class="data"></span>					<div class="uploadify-progress">						<div class="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				</div>';
			}

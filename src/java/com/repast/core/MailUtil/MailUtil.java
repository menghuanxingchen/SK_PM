package com.repast.core.MailUtil;
/**
*
* @author geloin
...
public class MailUtil {
	...
	public String getEmailHost() {
		emailHost = objToStr(emailHost);
		if (emailHost.equals("")) {
			emailHost = MailConstants.emailHost;
		}
		return emailHost;
	}
	...
	public String getEmailFrom() {
		emailFrom = objToStr(emailFrom);
		if (emailFrom.equals("")) {
			emailFrom = MailConstants.emailFrom;
		}
		return emailFrom;
	}
	...
	public String getEmailUserName() {
		emailUserName = objToStr(emailUserName);
		if (emailUserName.equals("")) {
			emailUserName = MailConstants.emailUsername;
		}
	...
	public String getEmailPassword() {
		emailPassword = objToStr(emailPassword);
		if (emailPassword.equals("")) {
			emailPassword = MailConstants.emailPassword;
		}
	...
	public String getSubject() {
		subject = objToStr(subject);
		if (subject.equals("")) {
			subject = "无主题";
		}
		return objToStr(subject);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		mu.setToEmails("xuning1@skccchina.com");
		mu.setToName("白天虹");
		mu.setContent(",有一个维修单需要您审批，谢谢！");
		sendMail(mu);
		 //test1(mu);
		// test2(mu);
		// test3(mu);
	...
	public static void sendMail(MailUtil mu) throws Exception {
		//String toEmails = "baitianhong@skccchina.com";
		String subject = "MES系统审批邀请";
		//String name = "白天虹";
		StringBuilder builder = new StringBuilder();
		builder.append(mu.getToName()+mu.getContent());
		String content = builder.toString();

		mu.setToEmails(mu.getToEmails());
	...
	public static void test1(MailUtil mu) throws Exception {
		String toEmails = "baitianhong@skccchina.com";
		String subject = "PM巡检系统审批邀请";
		String name = "白天虹";
		StringBuilder builder = new StringBuilder();
		builder.append(name+",有一个维修单需要您审批，谢谢！");
		String content = builder.toString();
	...
	public static void test2(MailUtil mu) throws Exception {
		String toEmails = "sunaibo@skccchina.com";
	...
	public static void test6(MailUtil mu) throws Exception {
		String toEmails = "sunaibo@skccchina.com";//774599724@qq.com;geloin@163.com

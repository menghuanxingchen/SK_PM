 ...
 * Company:
 * 表test_result_18 的实体类
 * @author 刘镝
 */
@Entity(name = "test_result_18")
public class TestResult18Info extends BaseEntity implements Serializable, Cloneable {

  public TestResult18Info clone() {
      TestResult18Info o = null;
      try {
          o = (TestResult18Info) super.clone();
   ...
   * 灌装机压盖效果是否正常
   */
  @Column(name = "filling_gland", comment = "灌装机压盖效果是否正常")
  private String filling_gland;

  /**
   *  桶身喷码机（ZIC专用）日期
   */
  @Column(name = "printer_mouth_zic", comment = " 桶身喷码机（ZIC专用）日期")
  private String printer_mouth_zic;

  /**
   * 桶身喷码机（ZIC专用）顺序号
   */
  @Column(name = "printer_mouth_num", comment = "桶身喷码机（ZIC专用）顺序号")
  private String printer_mouth_num;

  /**
   * 桶身喷码机（ZIC专用）批号
   */
  @Column(name = "printer_mouth_lot", comment = "桶身喷码机（ZIC专用）批号")
  private String printer_mouth_lot;
   ...
   * 扫码数量核对正确
   */
  @Column(name = "scan_first_num", comment = "扫码数量核对正确")
  private String scan_first_num;
   ...
   * 鐏岃鏈哄寘鏉愭槸鍚﹀悎鏍�
   */
  @Column(name = "filling_pakage_qualified", comment = "鐏岃鏈哄寘鏉愭槸鍚﹀悎鏍�")
...
public String getFilling_dateed() {
  ...
  public String getFilling_gland() {
       return filling_gland;
  }

  public void setFilling_gland(String filling_gland) {
       this.filling_gland = filling_gland;
  }

  public String getPrinter_mouth_zic() {
       return printer_mouth_zic;
  }

  public void setPrinter_mouth_zic(String printer_mouth_zic) {
       this.printer_mouth_zic = printer_mouth_zic;
  }

  public String getPrinter_mouth_num() {
       return printer_mouth_num;
  }

  public void setPrinter_mouth_num(String printer_mouth_num) {
       this.printer_mouth_num = printer_mouth_num;
  }

  public String getPrinter_mouth_lot() {
       return printer_mouth_lot;
  }

  public void setPrinter_mouth_lot(String printer_mouth_lot) {
       this.printer_mouth_lot = printer_mouth_lot;
  }
  ...
  public String getScan_first_num() {
       return scan_first_num;
  }

  public void setScan_first_num(String scan_first_num) {
       this.scan_first_num = scan_first_num;
  }

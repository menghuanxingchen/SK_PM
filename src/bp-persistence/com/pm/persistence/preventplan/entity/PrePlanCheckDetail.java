 ...
 * Company:
 * 表pre_plan_check_detail 的实体类
 * @author 刘镝
 */
@Entity(name = "pre_plan_check_detail")
public class PrePlanCheckDetail extends BaseEntity implements Serializable, Cloneable {

  private static final long serialVersionUID = 7055475116533424020L;

  public PrePlanCheckDetail clone() {
      PrePlanCheckDetail o = null;
      try {
          o = (PrePlanCheckDetail) super.clone();

...
public class SysCodeGroupInfo extends BaseEntity implements Serializable, Cloneable {

  private static final long serialVersionUID = 140176415760723591L;

  public SysCodeGroupInfo clone() {
      SysCodeGroupInfo o = null;
      try {
          o = (SysCodeGroupInfo) super.clone();

 ...
 */
@Controller
@RequestMapping("/SqmComplaintFeedbackController")
public class SqmComplaintFeedbackController {
    ...
    public String tablemanagePage() {
        return "web/sqmcomplaintfeedback/sqm_complaint_feedback_list";
    }
    ...
    public @ResponseBody JSONMap<String,Object> queryDataList(@FormModel SqmComplaintFeedback sqmComplaintFeedback,@FormModel Processor processor) {
        JSONMap<String,Object> model = new JSONMap<String,Object>();
        try{
            //列表查询（分页）
    ...
    public @ResponseBody JSONMap<String,Object> queryBeforeUpdate(@FormModel SqmComplaintFeedback sqmComplaintFeedback,@FormModel Processor processor) {
        JSONMap<String,Object> model = new JSONMap<String,Object>();
        try{
            SqmComplaintFeedback dataInfo = sqmComplaintFeedbackService.getSqmComplaintFeedbackById(sqmComplaintFeedback.getId());
    ...
    public @ResponseBody JSONMap<String,Object> addEntityData(@FormModel SqmComplaintFeedback sqmComplaintFeedback,@FormModel Processor processor) {
        JSONMap<String,Object> model = new JSONMap<String,Object>();
        try{
        	String resDay=DateUtil.getNow(DateUtil.Y_M_D_HMS);
        	sqmComplaintFeedback.setCreate_date(resDay);
        	sqmComplaintFeedback.setCreate_person(processor.getCurrentUserId());
            sqmComplaintFeedbackService.insertSqmComplaintFeedback(sqmComplaintFeedback);
            model.put(SysConstant.OP_FLAG, true);
            model.put(SysConstant.OP_MESSAGE, SysConstant.SUCCESS);
        }catch(Exception e){
            model.put(SysConstant.OP_FLAG, false);
    ...
    public @ResponseBody JSONMap<String,Object> updEntityData(@FormModel SqmComplaintFeedback sqmComplaintFeedback,@FormModel Processor processor) {
        JSONMap<String,Object> model = new JSONMap<String,Object>();
        try{
        	String resDay=DateUtil.getNow(DateUtil.Y_M_D_HMS);
        	sqmComplaintFeedback.setUpd_date(resDay);
        	sqmComplaintFeedback.setUpd_person(processor.getCurrentUserId());
            sqmComplaintFeedbackService.updSqmComplaintFeedback(sqmComplaintFeedback);
            model.put(SysConstant.OP_FLAG, true);
            model.put(SysConstant.OP_MESSAGE, SysConstant.SUCCESS);
        }catch(Exception e){
            model.put(SysConstant.OP_FLAG, false);
    ...
    public @ResponseBody JSONMap<String,Object> cancelEntityData(@FormModel SqmComplaintFeedback sqmComplaintFeedback,@FormModel Processor processor) {
        JSONMap<String,Object> model = new JSONMap<String,Object>();
        try{
            sqmComplaintFeedbackService.cancelSqmComplaintFeedback(sqmComplaintFeedback);
            model.put(SysConstant.OP_FLAG, true);
            model.put(SysConstant.OP_MESSAGE, SysConstant.SUCCESS);
        }catch(Exception e){
            model.put(SysConstant.OP_FLAG, false);
